...
def test_rust_acceleration_available():
    ...
    assert isinstance(fast_litellm.RUST_ACCELERATION_AVAILABLE, bool)

def test_apply_acceleration_function():
    """Test that the apply_acceleration function exists and is callable."""
    from fast_litellm.accelerator import apply_acceleration
...
def test_remove_acceleration_function():
    ...
    from fast_litellm.accelerator import remove_acceleration
...
def test_monkeypatch_module_import():
    ...
    try:
        from fast_litellm import monkeypatch
...
def test_auto_apply_acceleration():
    ...
    from fast_litellm.monkeypatch import auto_apply_acceleration

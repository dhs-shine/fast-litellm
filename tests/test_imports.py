...
def test_import():
    ...
    try:
        import fast_litellm
        assert fast_litellm.__version__ == "0.1.0"
    except ImportError:
        pytest.fail("Failed to import fast_litellm")

def test_rust_extensions_import():
    """Test that Rust extensions can be imported."""
    try:
        from fast_litellm import rust_extensions
...
def test_accelerator_import():
    ...
    try:
        from fast_litellm import accelerator
...
def test_diagnostics_import():
    ...
    try:
        from fast_litellm import diagnostics
